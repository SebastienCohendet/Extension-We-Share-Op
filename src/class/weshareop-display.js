...
(function(WeShareOp){
	...
	WeShareOp.prototype.displayData = function(_window){
		...
		if(this.financeData.value){
			...
			_gEBI('wso-capitalGain').value = (this.userData["ws2016"].capitalGain+this.userData["ws2017"].capitalGain+this.userData["ws2018"].capitalGain).toFixed(2)+'€';
			_gEBI('wso-overallGain').value = (this.userData["ws2016"].overallGain+this.userData["ws2017"].overallGain+this.userData["ws2018"].overallGain).toFixed(2)+'€';
		}
